package com.fruit.portal.action.wechat.neworder;
...
@Component
@UriMapping("/wechat/neworder")
public class GoodsWeChatAction extends BaseAction {

	@Autowired
	private GoodsInfoShowService goodsInfoShowService;

	private static final Logger logger = LoggerFactory.getLogger(GoodsWeChatAction.class);
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_all_goods_categories")
	public AjaxResult findAllGoodsCategories() {
		...
		{
			logger.error("[/wechat/neworder/findAllGoodsCategories].Exception:{}",e);
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_varieties_by_category" , interceptors = {"validationInterceptor"})
	public AjaxResult findGoodsVarietiesByCategory() {
		...
		{
			logger.error("[/wechat/neworder/findGoodsVarietiesByCategory].Exception:{}",e);
			return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
		}
	}
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_products_by_variety" , interceptors = {"validationInterceptor"})
	public AjaxResult findGoodsProductsByVariety() {
		...
		{
			logger.error("[/wechat/neworder/findGoodsProductsByCategory].Exception:{}",e);
			return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
		}
	}
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_commodities_by_product" , interceptors = {"validationInterceptor"})
	public AjaxResult findGoodsCommoditiesByProduct() {
		...
		{
			logger.error("[/wechat/neworder/findGoodsCommoditiesByProduct].Exception:{}",e);
			return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
		}
	}
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_products_commodities_by_variety" , interceptors = {"validationInterceptor"})
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_commodities_by_category" , interceptors = {"validationInterceptor"})
	public AjaxResult findGoodsCommoditiesByCategory() {
		...
		{
			logger.error("[/wechat/neworder/findGoodsCommoditiesByVariety].Exception:{}",e);
			return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
		}
	}
	 ...
	 * @return
	 */
	@UriMapping(value = "/wechat_find_goods_commodities_by_variety" , interceptors = {"validationInterceptor"})
