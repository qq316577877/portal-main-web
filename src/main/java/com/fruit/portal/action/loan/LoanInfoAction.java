 ...
 */
@Component
@UriMapping("/loan/info")
public class LoanInfoAction extends BaseAction
{
    private static final Logger LOGGER = LoggerFactory.getLogger(LoanInfoAction.class);
     ...
     * @return
     */
    @UriMapping(value = "/servicelist", interceptors = {"userLoginCheckInterceptor", "userNavigatorInterceptor"})
    public String loanInfoServiceList()
    {
        int userId = getLoginUserId();
        try
        {
            return "/loan/loan_service_list";
        }
        catch (IllegalArgumentException e)
        {
            LOGGER.error("[/loan/info/servicelist].Exception:{}",e);
     ...
     * @return
     */
    @UriMapping(value = "/applylist", interceptors = {"userLoginCheckInterceptor", "userNavigatorInterceptor"})
    public String loanInfoApplyList()
    {
        int userId = getLoginUserId();
        try
        {
            return "/loan/loan_applylist";
        }
        catch (IllegalArgumentException e)
        {
            LOGGER.error("[/loan/info/applylist].Exception:{}",e);
            return FTL_ERROR_400;
        }
    }
    ...
    public AjaxResult getLoanInfoApplyList()
    {
        ...
        int pageNo = (Integer) params.get("pageIndex");
        int pageSize = (Integer) params.get("pageSize");
        String keyword = (String) params.get("keyword");
        int status = (Integer) params.get("status");//默认-1，如果是-1，则为空
...
//            Map<String, Object> dataMap = new HashMap<String, Object>();
        ...
        {
            LOGGER.error("[/lopan/info/get_loan_info_list_apply_ajax].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
...
//            Map<String, Object> dataMap = new HashMap<String, Object>();
        ...
        {
            LOGGER.error("[/lopan/info/get_loan_info_list_service_ajax].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
    ...
    {
        try {
            long id = super.getIntParameter("id", 0);
            int userId = getLoginUserId();
        ...
        {
            LOGGER.error("[/loan/info/get_loan_info_details_ajax].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
    ...
    public AjaxResult<String> createLoanInfos() {
        ...
        {
            LOGGER.error("[/loan/info/create_loan_info_ajax].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
    ...
    public AjaxResult<String> loadLoanInfosByTransactionNoList() {
        ...
        {
            LOGGER.error("[/loan/info/loadLoanInfosByTransactionNoList].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
    ...
    public AjaxResult<String> loadLoanInfosByTransactionNo() {
        ...
        {
            LOGGER.error("[/loan/info/loadLoanInfosByTransactionNo].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
    ...
    public AjaxResult getLoanInfoInterestRate()
    {
        ...
        {
            LOGGER.error("[/loan/info/get_loan_info_interest_rate].Exception:{}",e);
            return new AjaxResult(AjaxResultCode.REQUEST_BAD_PARAM.getCode(), e.getMessage());
        }
    }
}
