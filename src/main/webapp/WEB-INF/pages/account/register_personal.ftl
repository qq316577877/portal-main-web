        ...
        <div class="vcBox ">
            ...
            <div class="vORc personage">
                <label>
                    ...
                    <input type="text" id="per-name" name="per_name" maxlength="25"/>
                    <p class="red judge"></p>
                </label><br/>

                <label>
                    <div class="input-l"><span>*</span> 身份证号：</div>
                    <input type="text" id="per-identity" name="per_identity" placeholder="个人居民身份证号" maxlength="18"/>
                    <p class="red judge"></p>
                </label><br/>
                ...
                <label>
                    ...
                    <div class="selectList">
                        ...
                        <select class="district mr0" id="district" name="district">
                ...
                <label>
                    ...
                    <input type="text" id="per-address" name="per_address"/>
                    <p class="red judge"></p>
                </label><br/>
                <label>
                    <div class="input-l"><span>*</span> 联系电话：</div>
                    <input type="text" id="per-phoneNum" name="per_phoneNum" maxlength="20"/>
                    <p class="red judge"></p>
                </label><br/>
